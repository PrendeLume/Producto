                ...
                <table id="categoriaTable" class="table table-bordered table-striped  dataTable">
                    ...
                    foreach($data as $categoria){
                        ...
                        <tr id="categoria-<?php echo $categoria->id; ?>">
                            ...
                            <td align="center"><a class="btn btn-clock btn-outline-primary" href="./?controller=categoria&action=edit&id_categoria=<?php echo $categoria->id; ?>"><i class="fas fa-edit"></i></a> 
                                <?php 
                                if(\Com\Daw2\Helpers\Utils::contains($_SESSION['usuario']['permisos']['Categoria'], 'd')){
                                ?>
                                <a class="btn btn-clock btn-outline-danger" href="./?controller=categoria&action=delete&id_categoria=<?php echo $categoria->id; ?>"><i class="fas fa-trash"></i></a>
                               <?php
                                }
                                ?>
                            </td>
