                        ...
                        <div class="row">                            
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="sexo" id="sexo">
                                        <option value="total" <?php echo (isset($sanitized['sexo']) && $sanitized['sexo'] == 'total') ? 'selected' : ''; ?>>Total</option>
                                        <option value="hombres" <?php echo (isset($sanitized['sexo']) && $sanitized['sexo'] == 'hombres') ? 'selected' : ''; ?>>Hombres</option>
                                        <option value="mujeres" <?php echo (isset($sanitized['sexo']) && $sanitized['sexo'] == 'mujeres') ? 'selected' : ''; ?>>Mujeres</option>
                                    </select>
                                    <?php
                                    if(isset($errors['sexo'])){
                                    ?>
                                    <p class="text-danger"><small><?php echo $errors['sexo']; ?></small></p>
                                    <?php
                                    }
                                    ?>
                                </div> 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ano" id="ano" class="form-control" value="<?php echo isset($sanitized['ano']) ? $sanitized['ano'] : ""; ?>" />
                                    <?php
                                    if(isset($errors['ano'])){
                                    ?>
                                    <p class="text-danger"><small><?php echo $errors['ano']; ?></small></p>
                                    <?php
                                    }
                                    ?>
                                </div> 
